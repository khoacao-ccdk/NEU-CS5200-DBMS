...
public class Employees {
     ...
     * @param wage
     */
    public Employees(int employeeId, String firstName, String lastName, String SSN, Date dOB, String email, String phone, String Street1, String street2, String city, String state, String zip, boolean status, String role, int wage) {
